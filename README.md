...
- the Engineering Task form relies on that workflow for `kind/*` / `area/*` (no static `kind/*` default). Consumers that inherit the form without copying the workflow will not get those labels automatically
